...
const MQ_PROCESS_ERROR_CODES = {
    ...
    ANSWER_ID_DOESNT_EXIST: 153,
}

const TASK_PROCESS_ERROR_CODES = {
    INVALID_TASK_TYPE: 200,
    INVALID_TASK_SUPER_TYPE: 201,
    INSUFFICIENT_CONTENT_TO_GENERATE_TASK: 202,
    INVALID_TASK_ID: 203,
}

// Exams
const EXAM_PROCESS_ERROR_CODES = {
    SET_ANSWERS_TO_QUESTION: 200,
    ADD_QUESTION_TO_EXAM: 201,
    GET_EXAM_BY_ID: 202,
}
...
module.exports = {
    ...
    EXAM_PROCESS_ERROR_CODES,
    TASK_PROCESS_ERROR_CODES,
}